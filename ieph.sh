...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/Nginx/nginx.conf"
...
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/Nginx/vps.conf"
...
# Setting Server
cd /etc/openvpn/
wget "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/OpenVPN/server.conf"

#Create OpenVPN Config
cd
mkdir -p /home/vps/public_html
cd /home/vps/public_html/
wget "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/OpenVPN/client.ovpn"
...
cd /etc/ufw/
wget "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/OpenVPN/before.rules"
cd
ufw enable
ufw status
ufw disable
...
# Install BadVPN
cd
wget -O /usr/bin/badvpn-udpgw "https://github.com/iephdevs/ssh/raw/master/Files/BadVPN/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/iephdevs/ssh/raw/master/Files/BadVPN/badvpn-udpgw64"
fi
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/Squid/squid3.conf"
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/Stunnel/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/Stunnel/stunnel.conf"
...
wget "https://github.com/iephdevs/ssh/raw/master/Files/Others/ddos-deflate-master.zip"
...
# Banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/Others/issue.net"
...
wget -O screenfetch "https://raw.githubusercontent.com/iephdevs/ssh/master/Files/Others/screenfetch"
chmod +x screenfetch

# Download Commands
cd /usr/bin
wget https://github.com/iephdevs/ssh/raw/master/Files/Menu/AutoScript_Menu.tar.gz
